                ...
                <div className='nav-main'>
                    <div className='nav-content' >
                        ...
                        <div className='search-button'>
                            <input value={searchQuery} type="text" placeholder="Search saylor" name="search" onChange={(e)=>setSearchQuery(e.target.value)} />
                        ...
                        <div class="dropdown">
                            ...
                            <div className="dropdown-content">
                                ...
                                <a href="#" onClick={()=>handleNavigationClick(3)}>My Profile</a>
                                <a href="">Logout</a>
                            </div>
                            </div>
